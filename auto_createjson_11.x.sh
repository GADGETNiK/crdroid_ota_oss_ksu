  ...
  "response": [
    {
        ...
        "device": "'$devicename'",
        "filename": "'$zip_only'",
        "download": "https://github.com/GADGETNiK/crdroid_ota_oss_ksu/releases/download/'$nozip'/'$zip'",
        "timestamp": '$timestamp',
        "md5": "'$md5'",
        "sha256": "'$sha256'",
        "size": '$size',
...
gh release create $nozip --notes "Automated release crDroid 11.x (VANILLA/KSU) for $device $version $date/$time" $path/out/target/product/$device/$zip
